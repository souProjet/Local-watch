            ...
            i.add({
                ...
                mounted: function (e) {
                    ...
                    t.on("localVideo", (function (t) {
                        console.log(r.childNodes[1].files[0]);
...
var film = decodeURI($_GET("film"));
var dir = decodeURI($_GET("dir"));
if (dir == "none") {
    ls = spawn("ls", [config.absolutePathToFilm]);
} else {
...
ls.stdout.on("data", data => {
    if (dir == "none") {
        var art = new Artplayer({
            ...
            url: config.absolutePathToFilm + "/" + data.toString().split("\n")[film],
            poster: './asset/miniature/' + data.toString().split("\n")[film].replace(/(\.[a-zA-Z0-9]+)/, "") + '.png',
            type: data.toString().split("\n")[film].split('.').pop().toLowerCase(),
            ...
            controls: [
                {
                    ...
                    position: 'right',
                    index: 10,
                    html: '<img style="width:30px; height:30px; transform:rotate(270deg)" src="./asset/image/fleche.png">',
                    tooltip: 'revenir au menu',
                    click: function () {
        ...
        var art = new Artplayer({
            container: '.artplayer-app',
            url: config.absolutePathToFilm + "/" + dir + "/" + data.toString().split("\n")[film],
            poster: './asset/miniature/' + data.toString().split("\n")[film].replace(/(\.[a-zA-Z0-9]+)/, "") + '.png',
            type: data.toString().split("\n")[film].split('.').pop().toLowerCase(),
            title: data.toString().split("\n")[film].toLowerCase().replace(/(\.[a-z0-9]+)/, ""),
            container: '.artplayer-app',
            ...
            controls: [
                {
                    ...
                    tooltip: 'revenir au menu',
                    click: function () {
                        window.location = "./index.html?dir=" + dir;
                    }
                }
